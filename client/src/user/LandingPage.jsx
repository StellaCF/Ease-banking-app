...
const faqItems = [
  {
    ...
    answer: 'Ease Bank enables fast, secure, and cost-effective cross-border money transfers.',
  },
  {
    question: 'Why should I trust Ease Bank?',
    answer: 'Ease Bank is regulated, uses advanced encryption, and has served thousands of happy users.',
  },
  {
  ...
  },
  {
    ...
    answer: 'You need a valid email address, a secure password, and identity verification.',
  },
];
  ...
  return (
     ...
     <Navbar/>
      ...
      <section className="flex flex-col w-10/12 mx-auto lg:flex-row items-center justify-between py-16">
        ...
        <div className="max-w-lg text-left">
          ...
          <p className="text-lg mb-6">
            Send funds to loved ones or receive payments from clients abroad with minimal fees, in just 5 minutes!
          </p>
          ...
          <div className="mt-6 flex items-center space-x-2">
            <div className="flex space-x-1">
              {[...Array(4)].map((_, i) => (
                <div key={i} className="w-5 h-5 bg-green-500 rounded text-white flex items-center justify-center">★</div>
              ))}
              <div className="w-5 h-5 bg-gray-300 rounded text-white flex items-center justify-center">★</div>
            </div>
      ...
      <section className="bg-white text-[#004876] py-20 px-6 md:px-20 flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="max-w-lg mb-10 lg:mb-0">
          <button className="mb-4 px-4 py-2 border border-[#004876] rounded-full text-sm">Make Transfer</button>
          <h2 className="text-4xl font-bold mb-6">Send money to your loved ones</h2>
          <div className="space-y-6">
            <div>
              <div className="flex items-center mb-2">
                <span className="mr-2">📹</span>
                <h4 className="text-lg font-semibold">Friends and Acquaintances</h4>
              </div>
              <p>Baby showers, birthdays, celebrations? Stay involved in the lives of your friends no matter the distance</p>
            </div>
            <div>
              <div className="flex items-center mb-2">
                <span className="mr-2">🏦</span>
        ...
        <div className="w-full md:w-1/2">
          ...
          <div className="space-y-6 text-white">
            ...
            <div>
              ...
              <p className="text-base text-white/90">
                Get paid hassle-free. No lengthy documentation, no waiting, no exclusions.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center gap-12">
        ...
        <div className="w-full md:w-1/2 text-[#02487F]">
          ...
          <div className="space-y-6 text-gray-700">
            <div>
              <h3 className="font-bold text-lg text-black">💼 Business Partners</h3>
              <p className="text-base">
                Pay for services and meet time-sensitive payment deadlines easily with Ease Bank.
              </p>
            </div>
            <div>
              <h3 className="font-bold text-lg text-black">📦 Suppliers</h3>
              <p className="text-base">
                Pay for your goods easily, meet shipment deadlines, and maintain business relationships with Ease Bank.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-xl space-y-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-sm">
              At Ease Bank, we strive for excellence by providing timely 24/7 assistance and ensuring a seamless cross-border transaction experience.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm">
              We prioritise seamless transactions to ensure your funds arrive promptly and reliably.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm">
              We are registered with all necessary bodies, including ASIC, and strictly adhere to regulatory compliance for customer safety and convenience.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm">
              We employ bank-grade security to protect your funds throughout the transfer process, ensuring safe and secure delivery.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full md:w-1/2 p-10">
        ...
        {[
          ...
          <div key={step.number} className="mb-6 flex items-start">
            ...
            <div>
              <h2 className="text-xl text-black font-semibold">{step.title}</h2>
      ...
      <div className="space-y-3">
        {faqItems.map((item, index) => (
          ...
          >
            ...
            >
              <span className="text-md font-semibold text-gray-800">{item.question}</span>
    ...
    <section className="bg-blue-50 py-16 px-4 sm:px-8">
      <div className="text-center mb-10">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mt-2">Don’t take our word, take theirs</h2>
      </div>
    ...
    <footer className="bg-white text-gray-700 text-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-10 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="#" className="hover:underline">Provide Feedback</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="#" className="hover:underline">Money Laundering Statement</a></li>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="mailto:help@Ease Bank.com.au" className="hover:underline">help@Ease Bank.com.au</a></li>
            <li><a href="tel:+61482076208" className="hover:underline">+61 482 076 208</a></li>
      ...
      <div className="border-t border-gray-200 mt-4 py-6 text-center text-sm px-4 sm:px-8">
        <p className="mb-2">
          Ease Bank Transfers, Level 6, 200 Adelaide Street, Brisbane City, QLD 4000.
        </p>
        <p className="mb-2">
          Orbuis Group Pty Ltd trading as Ease Bank Transfers is registered with Australia Securities and Investment Commission. ABN Number: 17 651 460 114. Orbuis Group Pty Ltd is registered with AUSTRAC
        </p>
        <p className="text-gray-500">©Ease Bank Platform 2025. Powered By Orbuis Group.</p>
      </div>
    </footer>
